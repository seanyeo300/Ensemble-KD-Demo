...
dataset_config = {
    ...
    "eval_meta_csv": os.path.join(dataset_dir, "meta.csv"),                                                         # Generates logit for baseline model with corret index.
    
    # "eval_dir": os.path.join(dataset_dir, "TAU-urban-acoustic-scenes-2024-mobile-evaluation"),                    # Use this for generating dcase submission
    # "eval_meta_csv": os.path.join(dataset_dir,  "TAU-urban-acoustic-scenes-2024-mobile-evaluation", "meta.csv")   
    
    #sub5
    
    # "logits_file": os.path.join("predictions","ensemble", "sub5_single_PaSST.pt")                                 # Single Teacher Distillation
    "logits_file": os.path.join("predictions","ensemble", "sub5_6_PaSST.pt")                                        # Ensemble Distillation
...
######################################### implementation of h5 dataloading ####################################
